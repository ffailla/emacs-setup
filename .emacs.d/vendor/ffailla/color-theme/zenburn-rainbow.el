(defun color-theme-zenburn-rainbow ()
"zenburn emacs with rainbow parens"
)
...
(defun color-theme-zenburn-rainbow ()
  ...
  (color-theme-install
   (append
    (list 'color-theme-zenburn-rainbow
    ...
    (zenburn-make-face-alias-clauses
     '(Buffer-menu-buffer-face
       ...
       ;;FF elscreen-tab-background-face
       ;;FF elscreen-tab-control-face
       ;;FF elscreen-tab-current-screen-face
       ;;FF elscreen-tab-other-screen-face
       identica-uri-face
...
(defalias 'zenburn-rainbow #'color-theme-zenburn-rainbow)

(provide 'zenburn-rainbow)
